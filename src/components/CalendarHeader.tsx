    ...
    <div className="flex items-center justify-center w-full mb-1">
      <div className="flex gap-2">
        <img
          ...
          alt="left arrow"
          className={cn(
            "size-6 border border-gray-300 rounded-md cursor-pointer hover:border-gray-500 "
          )}
        ...
        <img
          ...
          className={cn(
            "size-6 border border-gray-300 rounded-md cursor-pointer hover:border-gray-500 ",
            showingDate.year === MIN_NEPALI_YEAR &&
      ...
      <div className="flex gap-2">
        <img
          ...
          alt="left arrow"
          className={cn(
            "size-6 rotate-180 border border-gray-300 rounded-md cursor-pointer hover:border-gray-500 ",
            showingDate.year === MAX_NEPALI_YEAR &&
              "cursor-default hover:border-gray-300"
          )}
